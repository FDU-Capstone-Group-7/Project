...
def homepage(request):
    return render(request, 'Indie_Game/game/index.html')
...
def add_show(request):
    ...
    return render(request,'Indie_Game/game/addandshow.html',{'form':fm , 'games':game_list})
...
def update_data(request,id):
    ...
    return render(request,'Indie_Game/game/updateGame.html',{'form':fm})
